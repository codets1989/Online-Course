    ...
    return(
      ...
      <form className="form1" action="http://localhost:8000/Login" method="POST" onSubmit={loghandler} >
          ...
          <div>
            ...
            <input type ="text" name="username" id="username" value={userregis.username} className='regin' onChange={handleinput}  placeholder="Enter your Username" />
        </div>
        <div>
            <label htmlFor="password">Password</label>
            <input type ="password" name="password" id="password" value={userregis.password} className='regin' onChange={handleinput}  placeholder="Enter your password"/>
        </div>
